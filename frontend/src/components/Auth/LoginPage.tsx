    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white">
      ...
      <div className="mb-8 text-center">
        <div className="mb-6 flex items-center justify-center gap-2">
          <img src="/favicon-192.png" alt="Srlko" className="h-12 w-12 rounded-lg" />
          <span className="text-3xl font-bold text-slack-primary">srlko</span>
        </div>
        <h1 className="text-4xl font-bold text-slack-primary">Sign in to Srlko</h1>
